...
def main(flag,root,model_name, end_epoch, download):
    ''' main function
    ...
    dir_path = os.path.join(root, '%s_checkpoints' % (flag))
    ...
    train_dataset = DataClass(root=root,
                                    split='train',
                                    transform=transform,
                                    download=download)
    train_loader = data.DataLoader(dataset=train_dataset,
                                   ...
                                   shuffle=True)
    val_dataset = DataClass(root=root,
                                  split='val',
                                  transform=transform,
                                  download=download)
    val_loader = data.DataLoader(dataset=val_dataset,
                                 batch_size=batch_size,
                                 shuffle=True)
    test_dataset = DataClass(root=root,
                                   split='test',
                                   transform=transform,
                                   download=download)
